  ...
  return (
    <div className="text-white" >
      ...
      <div className="w-full flex justify-center">
        <div className="bg-orange-700 py-1 px-2 inline-flex justify-center rounded text-white m-4 text-center">
          Solana is facing congestion issues; This will affect how long it takes for your transactions to submit and the speed of raydium migrations. View more info <a href="https://twitter.com/0xMert_/status/1776023674098754014" className="text-blue-200 ml-1 hover:underline">here.</a>
        </div>
      </div>
